  ...
  return (
    <>
      ...
      <div
        ...
        `}
      >
        <div className="w-14 h-14 lg:w-18 lg:h-18 rounded-full border-4 border-white flex items-center justify-center shrink-0">
          {isCollapsed ? (
        ...
        {menuItems.map((item) => {
          ...
          return (
            <NavLink
              ...
              to={item.path}
              className={({ isActive }) =>
                `flex items-center gap-3 lg:gap-4 px-3 lg:px-5 py-2.5 lg:py-3 rounded-xl transition
                ${
                  isActive
      ...
      <div
        className={`
          mt-auto py-4 lg:py-6 transition-all duration-300 
      ...
      >
        <button
          onClick={onLogout}
          className={`
            flex items-center gap-3 lg:gap-4 text-white text-xs lg:text-sm opacity-90 hover:opacity-100 w-full
            ${isCollapsed ? 'justify-center' : ''}
          `}
